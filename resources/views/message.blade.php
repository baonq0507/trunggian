            ...
            <div class="row align-items-center gx-0">
                ...
                <div class="col">
                    <div class="input-group">
                        <textarea class="form-control px-0" placeholder="Type your message..." rows="1" data-emoji-input="" data-autosize="true" id="message"></textarea>
                ...
                <div class="col-auto">
                    <button class="btn btn-icon btn-primary rounded-circle ms-5" id="send-message" type="button">
