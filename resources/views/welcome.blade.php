        ...
        <div class="layout overflow-hidden">
            ...
            <nav class="navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
                ...
                <ul class="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3" role="tablist">
                    ...
                    <!-- Notification -->
                    <li class="nav-item nav-item d-none d-xl-block flex-xl-grow-1">
                        ...
                        <div class="d-flex flex-column h-100 position-relative">
                            <div class="hide-scrollbar">
                                ...
                                <div class="container py-8">
                                    ...
                                    <div class="card-list">
                                             <!-- Card -->
                                             <a href="/message" class="card border-0 text-reset">
                                                <div class="card-body">
                                                    <div class="row gx-5">
                                                        <div class="col-auto">
                                                            <div class="avatar">
                                                        ...
                                                        <div class="col">
                                                            <div class="d-flex align-items-center mb-3">
                                                                <h5 class="me-auto mb-0">Mua via cp mail</h5>
                                                                <span class="text-muted extra-small ms-2">23:20 PM</span>
                                                            </div>
                                              ...
                                              <a href="/message" class="card border-0 text-reset">
                                                <div class="card-body">
                                                    <div class="row gx-5">
                                                        ...
                                                        <div class="col">
                                                            <div class="d-flex align-items-center mb-3">
                                                                <h5 class="me-auto mb-0">Mua like fb</h5>
                                                                <span class="text-muted extra-small ms-2">17:10 PM</span>
                                                            </div>
    
                                                            <div class="d-flex align-items-center">
                                                                <div class="line-clamp me-auto text-success">
                                                                   Nhóm đã giao dịch xong!
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                              ...
                                              <a href="/message" class="card border-0 text-reset">
                                                <div class="card-body">
                                                    <div class="row gx-5">
                                                        ...
                                                        <div class="col">
                                                            <div class="d-flex align-items-center mb-3">
                                                                <h5 class="me-auto mb-0">Mua kênh ytb</h5>
                                                                <span class="text-muted extra-small ms-2">08:50 PM</span>
                                                            </div>
    
                                                            <div class="d-flex align-items-center">
                                                                <div class="line-clamp me-auto text-info">
                                                                   Nhóm đang chờ admin phân xử!
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
